(function() {
    ...
    function mostrarTareas() {
        ...
        //Para traducir los estados de la base de datos a palabras
        const estados = {
            0: 'Pendiente',
            1: 'Completa'
        }
        ...
        arrayTareas.forEach(tarea => {
            ...
            //Crea en el div los botones
            opcionesDiv.appendChild(btnEstadoTarea);
            opcionesDiv.appendChild(btneliminarTarea);

            //agregamos el nombre de la tarea y el div con los botones al contenedor
    ...
    function limpiarTareas() {
        ...
        //Va a ir eliminando el listado de tareas
